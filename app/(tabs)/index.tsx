/**
 * MAÇLAR — uygulamanın vitrini ve varsayılan açılış sekmesi.
 *
 ...
 *
 * NEDEN BU DÜZEN: eski "Genel Bakış" ekranı altı ayrı sorguyu tek ScrollView'e
 * yığıyordu; kullanıcı uygulamayı açtığında istediği tek şey "bugün ne var,
 * şu an ne oynanıyor" idi ve bunu bulmak için kaydırmak zorundaydı. Artık ilk
 * ekranda doğrudan maçlar var: başlık 48px, gün şeridi 58px, segment 32px —
 * geri kalan her piksel liste.
 *
