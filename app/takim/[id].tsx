...
const styles = StyleSheet.create({
  ...
  sTeamName: { fontSize: 11, fontWeight:"900", color:"#0A0812", letterSpacing:-0.3, lineHeight:15 },
  ...
  sStatV: { fontSize: 15, fontWeight:"900", color:"#5B21B6", fontVariant:["tabular-nums"] as any },
  ...
  sGoalV: { fontSize: 13, fontWeight:"900", color:"#5B21B6", fontVariant:["tabular-nums"] as any },
  ...
  h2hBtnText: { flex:1, fontSize: 13, fontWeight:"800", color:colors.turf },
  ...
  h2hSheetTitle: { fontSize: 15, fontWeight:"800", color:colors.line },
  ...
  h2hTeamName: { flex:1, fontSize: 12, fontWeight:"700", color:colors.line },
  h2hTeamPts: { fontSize: 11, fontWeight:"800", color:colors.turf },
  screen: {
    flex: 1,
